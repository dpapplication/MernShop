...
import { FaDollarSign, FaUsers, FaChartLine } from 'react-icons/fa'; // Import des icônes
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold">19550 $</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-3xl font-bold">26698</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-3xl font-bold">15681 $</p>
          </CardContent>
        </Card>
      </div>
